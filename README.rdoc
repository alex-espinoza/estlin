...
2. Create a new twitter application and get your consumer key and consumer secret tokens.

3. Create a <tt>.env</tt> file in the root directory and add the keys as shown below:
       export TWITTER_CONSUMER_KEY=token-goes-here
       export TWITTER_CONSUMER_SECRET=token-goes-here

4. <tt>rails s</tt> and you're good to go.
